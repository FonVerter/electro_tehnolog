...
def calculate_cutting_parameters(dxf_file):
    ...
    # Вывод результатов
    print(f"Общая длина реза: {total_length:.2f} мм")
    print(f"Общая площадь для вырезания: {total_area / 1_000_000:.6f} м²") 
...
calculate_cutting_parameters("C:\\Users\\FV\\Desktop\\python\\dxf-analyzer\\razni.DXF")

#кажется этот считает неверно длину реза. отсутствуют прорези.